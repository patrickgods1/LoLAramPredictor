...
riotConfig = {"api_key": "RGAPI-8d39bfd5-3d5c-4c07-8e41-9ff31f02f258",  # DaiLunChu # Developer API key: https://developer.riotgames.com/
                "apiRate": 1,
                "revisitSummoners": True,                                # Revisit summoner accounts to search for newer games
                "seedSummonerNames": ["Da Giggler", "ChillyTeaRex", 
                                      "candyofcotton", "KomodoCX2",
                                      "Qïngkai", "Taliyah Bot"],  # Seed summoner name for to start looking for matches
