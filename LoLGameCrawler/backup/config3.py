...
riotConfig = {"api_key": "RGAPI-5c91d514-055a-48ee-9edf-ad8c10890aa4",  # DaiLunChu # Developer API key: https://developer.riotgames.com/
                "apiRate": 1,
                "revisitSummoners": True,                                # Revisit summoner accounts to search for newer games
                "seedSummonerNames": ["Yuumí Abuser", "supercoolisaac", 
                                      "Zrky", "BUCKET AND A MOP",
                                      "Chaotic Clouds", "HangZhouFaker",
                                      "liche", "depressing life"],  # Seed summoner name for to start looking for matches
