...
def main() -> None:
    ...
    try:
        ...
        if os.path.isfile(r'.\GameWIP\progress.json') and os.access(r'.\GameWIP\progress.json', os.R_OK):
            with open(r'.\GameWIP\progress.json') as f:
                data = json.load(f)
        ...
        if not os.path.exists('GameWIP'):
            os.mkdir('GameWIP')
        with open(r'.\GameWIP\progress.json', 'w') as outputFile:
